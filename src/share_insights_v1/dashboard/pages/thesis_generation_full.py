            ...
            if analysis_type == 'dcf':
                ...
                <div style="min-width: 180px; max-height: 300px; overflow-y: auto; padding: 10px; border: 1px solid #ddd; border-radius: 5px; background: #fff; margin-right: 10px; position: relative;">
                    ...
                    <div id="dcf_{sanitized_ticker}" class="modal" style="display: none; position: fixed; z-index: 1000; left: 0; top: 0; width: 100%; height: 100%; background-color: rgba(0,0,0,0.5);">
                        <div id="dcf_{sanitized_ticker}_content" style="background-color: #1e1e1e !important; color: #000000 !important; margin: 5% auto; padding: 20px; border-radius: 10px; width: 80%; max-width: 600px; max-height: 80%; overflow-y: auto; transition: all 0.3s ease; -webkit-font-smoothing: antialiased; color-scheme: light;">
                            <style>
                ...
                <div style="min-width: 180px; max-height: 300px; overflow-y: auto; padding: 10px; border: 1px solid #ddd; border-radius: 5px; background: #fff; margin-right: 10px; position: relative;">
                    ...
                    <div id="news_{sanitized_ticker}" class="modal" style="display: none; position: fixed; z-index: 1000; left: 0; top: 0; width: 100%; height: 100%; background-color: rgba(0,0,0,0.5);">
                        <div id="news_{sanitized_ticker}_content" style="background-color: #1e1e1e !important; color: #000000 !important; margin: 5% auto; padding: 20px; border-radius: 10px; width: 80%; max-width: 600px; max-height: 80%; overflow-y: auto; transition: all 0.3s ease; -webkit-font-smoothing: antialiased; color-scheme: light;">
                            <style>
                            #news_{sanitized_ticker}_content * {{ color: #000000 !important; }}
                            #news_{sanitized_ticker}_content a {{ color: #0066cc !important; }}
                            </style>
                            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
                ...
                <div style="min-width: 180px; max-height: 300px; overflow-y: auto; padding: 10px; border: 1px solid #ddd; border-radius: 5px; background: #fff; margin-right: 10px; position: relative;">
                    ...
                    <div id="bm_{sanitized_ticker}" class="modal" style="display: none; position: fixed; z-index: 1000; left: 0; top: 0; width: 100%; height: 100%; background-color: rgba(0,0,0,0.5);">
                        <div id="bm_{sanitized_ticker}_content" style="background-color: #1e1e1e !important; color: #000000 !important; margin: 5% auto; padding: 20px; border-radius: 10px; width: 80%; max-width: 600px; max-height: 80%; overflow-y: auto; transition: all 0.3s ease; -webkit-font-smoothing: antialiased; color-scheme: light;">
                            <style>
